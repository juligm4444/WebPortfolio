...
const skills = [
  ...
  { name: 'SQL Developer', level: 70, category: 'Backend', icon: 'SQL Developer.svg' },
  { name: 'Mongo DB', level: 50, category: 'Backend', icon: 'MongoDB.svg' },
  { name: 'Flutter', level: 80, category: 'Mobile', icon: 'Flutter.svg' },
  { name: 'Android Studio', level: 70, category: 'Mobile', icon: 'Android Studio.svg' },
  { name: 'React Native', level: 50, category: 'Mobile', icon: 'React.svg' },
  { name: 'Git', level: 90, category: 'Tools', icon: 'Git.svg' },
  { name: 'Visual Studio Code', level: 90, category: 'Tools', icon: 'Visual Studio Code.svg' },
  { name: 'Figma', level: 80, category: 'Tools', icon: 'Figma.svg' },
  { name: 'Unreal Engine', level: 70, category: 'Tools', icon: 'Unreal Engine.svg' },
